...
#  $title = str_replace ( ' ' , '+' , 
	...
	$found = array () ;
    $url = "http://api.flickr.com/services/rest/?method=flickr.photos.search&api_key={$flickr_key}&sort=relevance&per_page={$flickrresults}&license=4,5,7&tag_mode=all&extras=tags&text=" . urlencode ( $title ) ;
